          ...
          return (
            <button
              ...
              className={`group flex-shrink-0 snap-center w-64 lg:w-full text-left flex flex-col items-start gap-3 p-4 sm:p-5 rounded-2xl transition-all duration-500 ease-out relative overflow-hidden ${
                isActive 
                  ? "glass-card border-orange-brand/25 shadow-[0_0_25px_-5px_rgba(249,115,22,0.12)] scale-[1.02]" 
            ...
            >
              ...
              {isActive && (
                <div className="absolute bottom-0 left-0 h-[2px] bg-orange-brand/10 w-full hidden lg:block">
                  <div 
                    className="h-full bg-orange-brand transition-all ease-linear"
                    style={{ 
              ...
              <div className={`flex items-center justify-center h-10 w-10 sm:h-12 sm:w-12 rounded-xl transition-colors ${
                isActive ? "bg-orange-brand/15 text-orange-brand" : "bg-white/[0.04] text-white/50 group-hover:text-orange-brand"
              }`}
              >
            ...
            >
              <div className="rounded-3xl glass-card flex flex-col overflow-hidden h-full border-white/[0.08]">
                ...
                <div className="relative h-48 sm:h-64 w-full">
                  ...
                  {/* Icon over image */}
                  <div className="absolute bottom-4 left-6 sm:left-8 glass h-12 w-12 rounded-xl text-orange-brand flex items-center justify-center">
                ...
                <div className="p-6 sm:p-8 flex flex-col flex-1 bg-[#111118]/80">
                  ...
                  <p className="text-base sm:text-lg font-light leading-relaxed text-white/70 mb-8">
                    {service.intro}
                  </p>
                  <div className="mt-auto">
                    <Link
                      ...
                      className="inline-flex items-center gap-3 rounded-full border border-orange-brand bg-orange-brand/10 px-6 sm:px-8 py-3.5 sm:py-4 text-xs sm:text-sm font-bold tracking-wide text-orange-brand transition-all hover:bg-orange-brand hover:text-white hover:shadow-[0_0_25px_rgba(249,115,22,0.3)]"
                    >
